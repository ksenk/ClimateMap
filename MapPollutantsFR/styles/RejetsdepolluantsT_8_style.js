...
var style_RejetsdepolluantsT_8 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("TOTAL_ALL_RELEASES");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 3.495800) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 3.495800 && value <= 28.157192) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 4.0 + size,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 28.157192 && value <= 72.755200) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 4.0 + size,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 72.755200 && value <= 200.310680) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 4.0 + size,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 200.310680 && value <= 117939.224700) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 4.0 + size,
